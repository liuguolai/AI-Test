...
# 添加新仓库远程地址
git remote add mini-games https://github.com/liuguolai/mini-games.git

# 推送到新仓库 main 分支
git push -u mini-games cursor/monorepo-wechat-mini-games-6011:main
```
...
**https://github.com/liuguolai/mini-games**
